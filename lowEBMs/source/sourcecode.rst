...
The structure of the model is provided by the :doc:`baseequation <code/baseequation>` package. It builds up the physical model from a set of physical :doc:`functions <code/functions>` which are specified in the
functions package. 
